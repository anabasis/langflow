---
title: "Langflow API specification"
source_url: "https://docs.langflow.org/api"
source_commit: "3ec070e99af5196fdb187546de2c4f29a35ebe46"
source_file: "API 명세 UI"
translation_type: "한국어 요약 번역"
---

# Langflow API specification

Langflow의 **Langflow API specification** 기능을 API 클라이언트에서 호출할 때 확인해야 하는 인증, 요청, 응답 및 실행 흐름을 안내하는 문서임.

> 이 문서는 공식 Langflow 문서를 바탕으로 작성한 한국어 요약 매뉴얼임. 버전별 옵션과 전체 예제는 아래 공식 원문 확인 필요.

## 문서 정보

- 공식 문서: [https://docs.langflow.org/api](https://docs.langflow.org/api)
- 원본 소스: [Langflow API specification](https://docs.langflow.org/api)
...
설정 필드, 전체 코드 예제, 버전별 제한 사항과 화면 이미지는 [공식 문서](https://docs.langflow.org/api) 및 [GitHub 원본](https://docs.langflow.org/api)에서 확인 가능.
